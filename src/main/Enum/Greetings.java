...
public enum Greetings {
    ...
    public static String getGreetingByLanguageAndTime(Language language, MomentOfTheDay time) {
    ...
    public static String getGoodByeByLanguageAndTime(Language language, MomentOfTheDay time) {
        if (language == Language.FRENCH) {
            switch (time) {
                case MATIN:
    ...
    public static String getCongratsByLanguageAndTime(Language language) {
        return (language == Language.FRENCH) ?
                Greetings.FELICITATIONS_FR.getGreeting() :
                Greetings.FELICITATIONS_EN.getGreeting();
    }

    public static String getConfirmPalindrom(Language language) {
        return (language == Language.FRENCH) ?
